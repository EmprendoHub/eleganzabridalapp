...
const BrandComponent = ({ lang, brandsection }) => {
  return (
    <div className="py-40 maxsm:py-20">
      <div className="flex flex-col items-center justify-center">
        <div className="box-one  w-full h-full flex flex-row maxsm:flex-col items-center justify-center">
        ...
        <div className="box-two  w-full h-full flex flex-row maxsm:flex-col-reverse items-center justify-center">
          <div className="col-right w-full h-full">
            <ImageLeftMotion
        ...
        <div className="box-three  w-full h-full flex flex-row maxsm:flex-col items-center justify-center">
          <div className="col-left  w-full h-full py-20 text-center">
            <ColTextComponent
