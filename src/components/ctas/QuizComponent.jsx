        ...
        <InnerSectionContainer>
             <div  className=' justify-center items-center text-center mx-auto py-20'>
                <div className='w-[50%] md:w-[90%]  mx-auto'>
                    ...
                    className='text-5xl md:text-3xl font-playfair-display mb-2'>{quiz.title}</motion.h2>
                    <motion.p 
                    initial={{y:50, opacity:0 }} 
                    whileInView={{y:0, opacity: 1 }} 
                    transition={{duration: 0.7}}
                    className=''>{quiz.subtitle}</motion.p>
                ...
                <div className='max-w-[70%] mx-auto flex flex-row md:flex-col mt-5'>
                    ...
                    className='flex flex-col p-4 items-center w-1/3 md:w-full'>
                        ...
                        <h2 className='text-2xl font-playfair-display my-2'>{quiz.boxone.title}</h2>
                    ...
                    transition={{duration: 0.9}} className='flex flex-col p-4 items-center w-1/3 md:w-full'>
                        ...
                        <h2 className='text-2xl font-playfair-display my-2'>{quiz.boxtwo.title}</h2>
                    ...
                    transition={{duration: 0.9}} className='flex flex-col p-4 items-center w-1/3 md:w-full'>
                        ...
                        <h2 className='text-2xl font-playfair-display my-2'>{quiz.boxthree.title}</h2>
                        <p className='text-xs'>{quiz.boxthree.subtitle}</p>
                    </motion.div>
                </div>
                <div className='max-w-full  mx-auto mt-10'>
                    
                <button className="py-3 px-6 rounded-full bg-black text-white hover:bg-white hover:text-black duration-700 text-sm uppercase font-semibold">{quiz.btntxt}</button>
