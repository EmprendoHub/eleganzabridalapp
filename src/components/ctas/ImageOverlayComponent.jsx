...
const ImageOverlayComponent = ({ imageoverlay, lang }) => {
  return (
    <div>
      <section
        className={`hero w-full h-[90dvh] bg-gray-100 text-center  bg-[url('/images/eleganza_bridal_dresses.webp')]  bg-cover bg-no-repeat bg-center maxsm:bg-left bg-fixed`}
      >
