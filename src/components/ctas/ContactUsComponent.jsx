  ...
  return (
    <div className="flex flex-row md:flex-col ">
      ...
      <div className="relative z-0">
        ...
        >
          <path
            d="M1169.02 134.869C1253.51 -46.9477 1620.92 -191.418 1528.08 727C1216.93 727 0 719.629 0 719.629C177.5 682 333.034 691.253 402.5 506.5C529 358 1049.58 432.939 1169.02 134.869Z"
            fill="#db2777"
          />
        </svg>
      </div>
