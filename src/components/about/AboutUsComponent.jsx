...
const AboutUsComponent = ({ about, quiz, lang }) => {
  return (
    <div>
      <section
        className={`hero w-full h-[500px] bg-gray-100 text-center  bg-[url('/images/Eleganza-bridal-las-vegas.webp')]  bg-cover bg-no-repeat bg-center bg-fixed`}
      >
        ...
        <section className="text-center w-1/2 md:w-full">
          <div className="container mx-auto px-6 sm:px-3">
            <SectionTextComponent
              ...
              paraTwo={about.mission.partwo}
              btnText={about.mission.btntext}
              btnUrl={`/${lang}/contact`}
            />
          </div>
        </section>
          ...
          <div className="container mx-auto">
            ...
            >
              <div className="bg-white rounded-lg p-4 shadow-md">
                <Image
                  src="/images/Eleganza-bridal-storefront-las-vegas.webp"
                  width={200}
                  height={200}
                  alt="Bridal Dresses and More"
      ...
      <section className="bg-gray-100 text-center py-12 w-[50%] md:w-[90%] p-5 mx-auto">
        <div className="container mx-auto">
          <InnerSectionTextComponent
            ...
            paraOne={about.makes.parone}
          />

          <div className="grid grid-cols-1 gap-4">
            <div className="bg-white rounded-lg p-8 shadow-md">
              <Image
                src={`/images/bridal_ornament_eleganza_bridal.webp`}
                width={200}
                height={200}
                alt="Team Member 1"
              ...
              <InnerSectionTextComponent
                paraOne={about.makes.paronetwo}
                btnText={about.makes.btntxt}
                btnUrl={`/${lang}/contact`}
              />
              <div className="mt-10" />
            </div>
      ...
      <section
        className={`hero w-full h-[600px] bg-gray-100 text-center  bg-[url('/images/novio-poniendo-anillo-dedo-novia.webp')]  bg-cover bg-no-repeat bg-center bg-fixed`}
      >
        <div className=" backdrop-brightness-50 w-full h-full items-center  justify-center flex px-40 md:px-10 my-20">
          <div className="container mx-auto">
            <div className="container mx-auto">
              <HeroTextComponent
                title={about.different.title}
                subtitle={about.different.subtitle}
                btnText={about.different.btntxt}
                btnUrl={`/${lang}/contact`}
              />
            </div>
          </div>
      ...
      <div className="mt-20">
        <InnerSectionTextComponent
          ...
          paraOne={about.testimonials.parone}
        />
