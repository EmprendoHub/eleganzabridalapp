        ...
        <div>
          ...
          <ul className="text-sm font-light mt-2 flex flex-col gap-y-2">
            <motion.li 
              ...
              <a href={`/${lang}/catalog?category=wedding`} className="text-slate hover:text-gray-900 cursor-pointer duration-200">
            ...
            <motion.li 
              ...
              whileTap={{ y:1 }} 
              transition={{duration: 0.15}} className="flex flex-col">
              <a href={`/${lang}/catalog?category=quinces`} className="text-slate hover:text-gray-900 cursor-pointer duration-200">
            ...
            <motion.li 
              ...
              whileTap={{ y:1 }} 
              transition={{duration: 0.15}} className="flex flex-col">
              <a href={`/${lang}/catalog?category=tuxedo`} className="text-slate hover:text-gray-900 cursor-pointer duration-200">
            ...
            <motion.li 
              ...
              whileTap={{ y:1 }} 
              transition={{duration: 0.15}} className="flex flex-col">
              <a href={`/${lang}/catalog?keyword=Quinceañera Accessories`} className="text-slate hover:text-gray-900 cursor-pointer duration-200">
