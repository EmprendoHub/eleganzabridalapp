...
const termsOfService = () => {
  return (
    <div>
      <div className="bg-white p-6 px-20 maxmd:px-10">
        <section className="hero bg-gray-100 text-center py-20">
          <div className="container mx-auto">
            ...
            <p className="text-lg text-gray-600 mt-4">
              This website is operated by Eleganza Bridal-LV. Throughout the
              site, the terms “we”, “us” and “our” refer to Eleganza Bridal-LV.
              Eleganza Bridal-LV offers this website, including all information,
        ...
        <section className="mb-4">
          ...
          <p className="mt-2">
            ...
            otherwise objectionable or violates any partys intellectual property
        ...
        <section className="mb-4">
          ...
          <p className="mt-2">
            our submission of personal information through the store is governed
        ...
        <section className="mb-4">
          ...
          <p className="mt-2">
            In no case shall Eleganza Bridal-LV, our directors, officers,
        ...
        <section className="mb-4">
          ...
          <p className="mt-2">
            You agree to indemnify, defend and hold harmless Eleganza Bridal-LV
        ...
        <section className="mb-4">
          ...
          <p className="mt-2">
            n the event that any provision of these Terms of Service is
        ...
        <section className="mb-4">
          ...
          <p className="mt-2">
            ...
            accordance with the laws of 1000 E Charleston Blvd #105, Las Vegas,
            NV 89104, USA
          </p>
        </section>
        ...
        <section className="mb-4">
          ...
          <p className="mt-2">
            ...
            compliance@eleganzabridal-lv.com
          </p>
        </section>
      </div>
    </div>
